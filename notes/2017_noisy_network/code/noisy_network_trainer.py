...
from .noisy_network_agent import NoisyNetworkAgent
from .replay_buffer import ReplayBuffer


class NoisyNetworkTrainer():
    ...
    def train(self, env):
        agent = NoisyNetworkAgent(epsilon=self.epsilon_scheduler(self.total_steps), actions=list(range(env.action_space.n)), device=self.device)  
        observe_interval = 0
